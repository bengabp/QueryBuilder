...
class CompaniesSearchResult(BaseModel):
    results: List[Dict] = Field(
        description="List of companies matching filters/search criteria"
    )
...
class SettingsResponse(BaseModel):
    ...
    filter_key_indices: Dict = Field(
        alias="filterKeyIndices",
        default={
